...
class Menu_Hover_Fill extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Menu Hover Fill', 'elemendas-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'elemendas-nav-menu__align-',
				'condition' => [
					'layout!' => 'dropdown',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'elemendas-nav-menu--dropdown-',
				'condition' => [
					'layout!' => 'dropdown',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'elemendas-nav-menu--',
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'elemendas-nav-menu__text-align-',
				'condition' => [
					'dropdown!' => 'none',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'elemendas-nav-menu--toggle elemendas-nav-menu--',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elemendas-nav-menu .elementor-item',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--main .elementor-item' => 'color: {{VALUE}}; fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--main .elementor-item:hover,
					{{WRAPPER}} .elemendas-nav-menu--main .elementor-item.elementor-item-active,
					{{WRAPPER}} .elemendas-nav-menu--main .elementor-item.highlighted,
					{{WRAPPER}} .elemendas-nav-menu--main .elementor-item:focus' => 'color: {{VALUE}}; fill: {{VALUE}};',
				],
				'condition' => [
					'pointer!' => 'background',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					{{WRAPPER}} .elemendas-nav-menu--main .elementor-item.elementor-item-active,
					{{WRAPPER}} .elemendas-nav-menu--main .elementor-item.highlighted,
					{{WRAPPER}} .elemendas-nav-menu--main .elementor-item:focus' => 'color: {{VALUE}}',
				],
				'condition' => [
					'pointer' => 'background',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--main:not(.e--pointer-framed) .elementor-item:before,
					{{WRAPPER}} .elemendas-nav-menu--main:not(.e--pointer-framed) .elementor-item:after' => 'background-color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--main .elementor-item.elementor-item-active' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--main:not(.e--pointer-framed) .elementor-item.elementor-item-active:before,
					{{WRAPPER}} .elemendas-nav-menu--main:not(.e--pointer-framed) .elementor-item.elementor-item-active:after' => 'background-color: {{VALUE}}',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--main .elementor-item' => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--main .elementor-item' => 'padding-top: {{SIZE}}{{UNIT}}; padding-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .elemendas-nav-menu--main:not(.elemendas-nav-menu--layout-horizontal) .elemendas-nav-menu > li:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--dropdown' => 'background-color: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--dropdown a:hover,
					{{WRAPPER}} .elemendas-nav-menu--dropdown a.elementor-item-active,
					{{WRAPPER}} .elemendas-nav-menu--dropdown a.highlighted' => 'background-color: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--dropdown a.elementor-item-active' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--dropdown a.elementor-item-active' => 'background-color: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'line_height' ],
				'selector' => '{{WRAPPER}} .elemendas-nav-menu--dropdown .elementor-item, {{WRAPPER}} .elemendas-nav-menu--dropdown  .elementor-sub-item',
				'separator' => 'before',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elemendas-nav-menu--dropdown',
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--dropdown' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .elemendas-nav-menu--dropdown li:first-child a' => 'border-top-left-radius: {{TOP}}{{UNIT}}; border-top-right-radius: {{RIGHT}}{{UNIT}};',
					'{{WRAPPER}} .elemendas-nav-menu--dropdown li:last-child a' => 'border-bottom-right-radius: {{BOTTOM}}{{UNIT}}; border-bottom-left-radius: {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elemendas-nav-menu--main .elemendas-nav-menu--dropdown, {{WRAPPER}} .elemendas-nav-menu__container.elemendas-nav-menu--dropdown',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--dropdown a' => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}}',
				],
				'separator' => 'before',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--dropdown a' => 'padding-top: {{SIZE}}{{UNIT}}; padding-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elemendas-nav-menu--dropdown li:not(:last-child)',
				'exclude' => [ 'width' ],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--dropdown li:not(:last-child)' => 'border-bottom-width: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elemendas-nav-menu--main > .elemendas-nav-menu > li > .elemendas-nav-menu--dropdown, {{WRAPPER}} .elemendas-nav-menu__container.elemendas-nav-menu--dropdown' => 'margin-top: {{SIZE}}{{UNIT}} !important',
				],
				'separator' => 'before',
			]
		);
	...
	protected function render() {
		...
		if ( 'dropdown' !== $settings['layout'] ) :
			$this->add_render_attribute( 'main-menu', 'class', [
				'elemendas-nav-menu--main',
				'elemendas-nav-menu__container',
				'elemendas-nav-menu--layout-' . $settings['layout'],
			] );
		...
		<div <?php $this->print_render_attribute_string( 'menu-toggle' ); ?>>
			...
			<nav class="elemendas-nav-menu--dropdown elemendas-nav-menu__container" role="navigation" aria-hidden="true">
				<?php
					// PHPCS - escaped by WordPress with "wp_nav_menu"
...
//		var_dump($item);
	...
	public function handle_sub_menu_classes( $classes ) {
		$classes[] = 'elemendas-nav-menu--dropdown';
