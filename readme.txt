...
1. From your WordPress dashboard -> Go to Plugins -> Click on 'Add new'-> In the Search field, enter "Elemendas Addons" and choose it.
2. Press install -> After installation, click Activate.

Alternatively:
1. Extract the zip file and drop the contents of the entire `elemendas-addons` folder in the `wp-content/plugins/` directory of your WordPress installation.
2. Activate the plugin through the 'Plugins' menu in WordPress.

== Frequently Asked Questions ==

**How do I install Elemendas Addons?**

To install Elemendas Addons, follow the steps below:
From your WordPress dashboard -> Go to Plugins -> Click on 'Add new'-> In the Search field, enter Elemendas Addons and choose it.
Press install -> After installation, click Activate.

**How do I use the Search Results Widget?**
...
5. Then drag and drop the Search Results Widget
...
**Remember**: this widget will only appear in archive templates.
...
7. Search terms text color highlight
8. Search terms background color highlight
...
= 1.1.0 =
* Added Quotation Marks control for search terms highlight
